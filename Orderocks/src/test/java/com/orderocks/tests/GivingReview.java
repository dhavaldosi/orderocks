...
public class GivingReview extends BaseClass {
	...
	public void EnterReviews() {
		...
		Assert.assertEquals(home.getsubmitmsg(),"You will see the product review after approving by a store administrator.");
